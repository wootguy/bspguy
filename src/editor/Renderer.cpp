...
Renderer::Renderer() {
	...
	//MdlRenderer* testMdl = new MdlRenderer(mdlShader, "models/cm_v3/tor.mdl");
	//MdlRenderer* testMdl = new MdlRenderer(mdlShader, "models/player/ryors_sphere/ryors_sphere.mdl");
